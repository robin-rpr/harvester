...
import {IRegisterType} from './models/napi.model';
...
export class AppComponent implements AfterViewInit, OnInit {
    ...
    async ngOnInit() {
        ...
        this.napiService.register(IRegisterType.DEVTOOLS_PANEL, {
            title: environment.config.devTools.title,
            iconPath: environment.config.devTools.icon,
            pagePath: environment.config.devTools.pagePath
        });
